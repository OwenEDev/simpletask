...
export default function TaskPage() {
    ...
    const {apiAddTask, apiDeleteTask, apiUpdateTask, getTasks} = apiCalls();    
    ...
    let defaultTasks = [
        { id: "1", name: "Make task manager app" },
        { id: "2", name: "Send app to recruiter" },
    ];
    ...
    useEffect(() => {
        const fetchTasks = async () => {
            ...
            setTasks([...fetchedTasks, ...defaultTasks]);
        };
        fetchTasks();
    }, []);
